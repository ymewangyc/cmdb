...
class Asset(models.Model):
    ...
    c_time = models.DateTimeField(auto_now_add=True,verbose_name='批注日期')
...
class Contract(models.Model):
    ...
    price = models.IntegerField('合共金额')
...
class EventLog(models.Model):
    ...
    user = models.ForeignKey(User,blank=True,null=True,verbose_name='事件执行人',on_delete=models.SET_NULL)  # 自动更新数据时没有执行人
    memo = models.TextField('备注',blank=True,null=True)
